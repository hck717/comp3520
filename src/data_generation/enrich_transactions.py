...
def load_kaggle_data():
    ...
    try:
        ...
        print(f"✅ Loaded {len(df_trade)} records from GlobalTradeSettleNet")
    except FileNotFoundError:
        print("⚠️  GlobalTradeSettleNet not found, creating sample data...")
        df_trade = create_sample_trade_data(1000)
    
    try:
        df_customs = pd.read_csv('data/raw/cross_border_customs.csv')
        print(f"✅ Loaded {len(df_customs)} records from Cross-Border Customs")
    except FileNotFoundError:
        print("⚠️  Customs data not found, creating sample shipment data...")
...
def generate_trade_finance_documents(df_trade, df_customs, num_records=1000):
    ...
    try:
        ...
        print(f"✅ Loaded {len(sanctioned_names)} sanctioned entities for matching")
    except FileNotFoundError:
        print("⚠️  Sanctions list not found. Run generate_sanctions_list.py first.")
        sanctioned_names = []
...
if __name__ == "__main__":
    ...
    print("\n🔄 Generating trade finance documents...")
    ...
    print(f"\n✅ Generated {len(df_enriched)} complete trade finance records")
